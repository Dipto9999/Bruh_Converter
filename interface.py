...
general_button_font = Font(family = 'Arial', size = 10, weight = 'normal')


general_label_bg = '#09F90D'
general_label_font = Font(family = 'Ubuntu Mono', size = 10, weight = 'normal')
...
def initScreen() :
    ...
    conversion_pane.grid(row = 0, column = 0)

    nameButton = tk.Button(conversion_pane, text = 'Hi. What is your name?', bg = general_button_bg, fg = 'black', 
...
def startConversion(name) :
    ...
    prepare_conversion = tk.Label(conversion_pane, text = f'Hello {name}. I have something to tell you. ', 
        bg = general_label_bg, fg = 'black', font = general_label_font, anchor = tk.E, borderwidth = 2)
    ...
    if (message_to_console != bruh.name_too_short) :
        prepare_reduced = tk.Button(conversion_pane, text = 'Do you want to BRUH-ify again? ', bg = general_button_bg, fg = 'black', 
...
def continueConversion(phrase, continue_count, stop_conversion) :
            ...
            if (not end_of_bruh) :
                ...
                print_reduced = tk.Label(conversion_pane, text = reduced_bruh, bg = general_label_bg, fg = 'black', 
                ...
                if (reduced_bruh == bruh.reduction_finished) :
                    ...
                    duplicate_prepare_reduced = tk.Button(conversion_pane, text = 'Do you want to BRUH-ify again? ', bg = general_button_bg, fg = 'black', 
                        font = general_button_font, borderwidth = 2, 
